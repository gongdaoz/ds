...
public class DataSourceControllerTest extends AbstractControllerTest{
   ...
   @Ignore
    ...
    public void testCreateDataSource() throws Exception {
        ...
        paramsMap.add("name","odps");
        paramsMap.add("node","odps data source test");
        paramsMap.add("type","ODPS");
        paramsMap.add("host","http://service.cn-hangzhou.maxcompute.aliyun.com");
        paramsMap.add("port","/api");
        paramsMap.add("principal","");
        paramsMap.add("database","odps_create_table");
        paramsMap.add("userName","LTAI4FyFwumzxEoN3TK95hWc");
        paramsMap.add("password","KvpnnEX80DY6TGtDajfsWkg46cO2Mb@123");
        paramsMap.add("other","");
