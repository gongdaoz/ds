...
public class BaseDataSourceTest {
  ...
  public void testDriverClassSelector() {
    ...
    String odpsDriverClass=new OdpsDataSource().driverClassSelector();
    Assert.assertEquals(Constants.COM_ODPS_JDBC_DRIVER,odpsDriverClass);
  }
  ...
  public void testGetJdbcUrl() {
    ...
    // odps  "jdbc:odps:http://service.cn-hangzhou.maxcompute.aliyun.com/api?project=odps_create_table"
    BaseDataSource odpsDataSource=new OdpsDataSource();
    odpsDataSource.setAddress("jdbc:odps:http://service.cn-hangzhou.maxcompute.aliyun.com/api");
    odpsDataSource.setDatabase("odps_create_table");
