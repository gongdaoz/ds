...
public final class Constants {
     ...
     *about datax
     */
    public static final String DATAX_HOME="datax.home";
    public static final String DATAX_CHANNEL_COUNT="num.datax.channel";
    public static final String DATAX_PYTHON_HOME="python.version";
    ...
    public static final String COM_ODPS_JDBC_DRIVER="com.aliyun.odps.jdbc.OdpsDriver";
    ...
    public static final String ODPS_HOST_PREFIX="http://";
    ...
    public static final String JDBC_ODPS = "jdbc:odps:";
