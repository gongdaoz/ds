...
public abstract class AbstractCommandExecutor {
    ...
    private void buildProcess(String commandFile) throws IOException {
        ...
        if (OSUtils.isWindows()) {
            ...
            // setting up a working directory(\tmp\dolphinscheduler\exec\process\1\3\20\23)
//            processBuilder.directory(new File("c:"+taskExecutionContext.getExecutePath()));
    ...
    public CommandExecuteResult run(String execCommand) throws Exception{
        ...
        // create command file if not exists 创建.bat文件
