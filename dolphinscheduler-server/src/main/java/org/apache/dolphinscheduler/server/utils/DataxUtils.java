...
public class DataxUtils {
    ...
    public static final String DATAX_READER_PLUGIN_ODPS="odpsreader";

    public static final String DATAX_READER_PLUGIN_CLICKHOUSE="clickhousereader";

    public static final String DATAX_WRITER_PLUGIN_ODPS="odpswriter";
    ...
    public static String getReaderPluginName(DbType dbType) {
        switch (dbType) {
            ...
            case ODPS:
                return DATAX_READER_PLUGIN_ODPS;
    ...
    public static String getWriterPluginName(DbType dbType) {
        switch (dbType) {
            ...
            case ODPS:
                return DATAX_WRITER_PLUGIN_ODPS;
            default:
                return null;
        }
    }
